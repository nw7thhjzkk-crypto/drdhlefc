...
export default async function OwnerDashboard() {
  ...
  const [
    ...
    supabase.from("diet_plans").select("*", { count: "exact", head: true }).in("status", ["active", "archived"]),
    supabase.from("workout_plans").select("*", { count: "exact", head: true }).in("status", ["active", "archived"]),
  ]);
