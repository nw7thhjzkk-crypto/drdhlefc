      ...
      {(!trainers || trainers.length === 0) ? (
        <div className="bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden">
          <div className="flex flex-col items-center justify-center space-y-4 bg-zinc-950/60 p-10 text-center">
            <h3 className="text-lg font-semibold text-yellow-500">No trainers yet</h3>
            <p className="max-w-md text-sm text-zinc-500">
              Add your first trainer to assign members, track specializations, and manage coaching capacity.
            </p>
            <Link
              href="/owner/trainers/new"
