        ...
        <form action={saveGymSettings} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="text" name="clubName" defaultValue={settings?.club_name || "Dr DHL Elite Fitness Club"} required className="mt-1 block w-full bg-zinc-950 border border-zinc-800 rounded p-2 text-zinc-200 focus:border-yellow-500" />
            </div>
            <div>
              <label className="block text-sm font-medium text-zinc-400">Support Email</label>
              <input type="email" name="supportEmail" defaultValue={settings?.support_email || "admin@drdhlelite.com"} required className="mt-1 block w-full bg-zinc-950 border border-zinc-800 rounded p-2 text-zinc-200 focus:border-yellow-500" />
            </div>
          </div>
          <div>
            <label className="block text-sm font-medium text-zinc-400">Club Address</label>
            <textarea rows={3} name="clubAddress" defaultValue={settings?.club_address || "123 Elite Avenue, Fitness City"} required className="mt-1 block w-full bg-zinc-950 border border-zinc-800 rounded p-2 text-zinc-200 focus:border-yellow-500"></textarea>
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-zinc-950 border border-zinc-800 rounded">
            ...
            <input type="checkbox" name="premiumTheme" defaultChecked={settings ? settings.premium_theme : true} className="h-5 w-5 rounded text-yellow-500 focus:ring-yellow-500 bg-zinc-900 border-zinc-700" />
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-zinc-950 border border-zinc-800 rounded mt-4">
            ...
            <input type="checkbox" name="geminiAiFeatures" defaultChecked={settings ? settings.gemini_ai_features : true} className="h-5 w-5 rounded text-yellow-500 focus:ring-yellow-500 bg-zinc-900 border-zinc-700" />
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-zinc-950 border border-zinc-800 rounded mt-4">
            ...
            <input type="checkbox" name="googleDriveIntegration" defaultChecked={settings ? settings.google_drive_integration : true} className="h-5 w-5 rounded text-yellow-500 focus:ring-yellow-500 bg-zinc-900 border-zinc-700" />
          </div>
